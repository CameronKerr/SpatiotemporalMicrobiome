...
myp <- plot_ordination(physeq_rarefy, ordu, color = "location_type", shape = "type") + 
  ...
  labs(color = "Location Type", shape = "Sample Type")
## Permanova
...
d_myp <- plot_ordination(d_physeq, ordu, color = "timepoint", shape = "location_type") + 
...
c_myp <- plot_ordination(c_physeq, c_ordu, color = "location", shape = "location_type") + 
